...
\xlin\ can be used interchangeably with almost any other POSIX compliant operating systems such as FreeBSD or Haiku.
...
Compressed, System and Hidden. Under \xlin, they can be Executable, Readable, Writable, Hidden.
...
\begin{center}
\framebox{\parbox{\xboxsize}{WINDOWS\\On \xmswin, any file that starts with a dot e.g. \texttt{'.netbeans'} will have its attribute shown as hidden, even when it does not have a hidden attribute.}}
\end{center}
...
\begin{center}
\framebox{\parbox{\xboxsize}{GLOBBING\\\texttt{'*.doc'} refers to all files ending in \texttt{'.doc'}.}}
\end{center}
...
\begin{center}
    ...
    * & Multi character Wildcard & d*n = don, down, doooooown, dominican \\ \hline
    \hline
    \end{tabular}
\end{center}
...
\index{Tagging!regular expressions}
Filters are a more complex form of pattern matching, known as regular expressions.
...
\vfill \eject
\section{Credits, Licensing and Trademarks}
\subsection{Credits}
