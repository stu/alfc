...
\xlin\ can be used interchangably with almost any other posix compliant operating systems such as FreeBSD or Haiku.
...
\begin{center}
\framebox{\parbox{\xboxsize}{WINDOWS\\On \xmswin, any file that starts with a dot eg \texttt{'.netbeans'} will have its attribute shown as hidden, even when it does not have a hidden attribute.}}
\end{center}
...
\begin{center}
    ...
    * & Multi character Wildcaard & d*n = don, down, doooooown, dominican \\ \hline
    \hline
    \end{tabular}
\end{center}
