solution "alfm"
   ...
   -- relies on bin2c being built
	project "alfc"
		...
		configuration "linux"
			buildoptions { "-D__USE_LARGEFILE64=1","-D_FILE_OFFSET_BITS=64","-DBUILD_UNIXLIKE"}
...
if _ACTION == "clean" then
	...
	local ff = os.matchfiles("*.o", "*.obj", "*.bak", "version.c", "lua_helper.c", "lua_common_api.c", "lua_helper_viewer.c", "lua_helper_vblist.c", "lua_common.h", "lua_api.h", "viewer.h", "vblist.h", "defaults.h")
	local k,v
